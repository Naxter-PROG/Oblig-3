...
# Finner komunnenen med lavest gjennomsnitts barn i 1 og 2 års alderen
...
print(f"Kommunene med lavest gjennomsnits antall barn i barnehagen mellom i 2 års alderen:\n{highest_kommune}")